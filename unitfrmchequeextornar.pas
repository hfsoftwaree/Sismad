...
type
  Tfrmchequesestornar = class(TForm)
    Image1: TImage;
    Panel2: TPanel;
    BitBtn1: TBitBtn;
    BitBtn3: TBitBtn;
    frmchequeextornar: TLabel;
...
var
  frmchequesestornar: Tfrmchequesestornar;
...
procedure Tfrmchequesestornar.BitBtn3Click(Sender: TObject);
begin
Close;
end;

procedure Tfrmchequesestornar.TipoClick(Sender: TObject);
begin
