object frmLimparBD: TfrmLimparBD
  ...
  Caption = 'Limpeza do Banco de Dados'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object CheckBox5: TCheckBox
      ...
      Width = 169
      Height = 17
      Caption = 'Movimento de Sa'#237'da'
      TabOrder = 11
    ...
    object CheckBox13: TCheckBox
      ...
      Width = 161
      Height = 17
      Caption = 'Tipo de Fornecedor/Cliente'
      TabOrder = 7
    end
    ...
    object GroupBox1: TGroupBox
      ...
      Height = 81
      Align = alCustom
      Caption = 'Selecione o per'#237'odo desejado para limpeza'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clNavy
      Font.Height = -11
      Font.Name = 'MS Sans Serif'
    ...
    object tipo: TRadioGroup
      ...
      Height = 80
      Align = alCustom
      Caption = 'Selecione o tipo de limpeza'
      Columns = 2
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clNavy
      Font.Height = -11
  ...
  object DataSource1: TDataSource
    DataSet = TSTATUSENTREGA
    Left = 377
    Top = 105
  end
  object TSTATUSENTREGA: TIBTable
