...
procedure Tfrmcategoria.Edit1Change(Sender: TObject);
begin
...
procedure Tfrmcategoria.DBEdit2KeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then
  bitbtn1.Click;
end;

procedure Tfrmcategoria.BitBtn4Click(Sender: TObject);
begin
...
begin
  try
    categoria.Post;
    categoria.Refresh;
    If Application.MessageBox('Gostaria de incluir outra Categoria?', 'Confirmação',
    mb_YesNo + mb_ICONQUESTION) = idYes then
    begin
    categoria.Append;
    dbedit2.SetFocus;
    ...
    Application.MessageBox('Categoria já Cadastrada!', 'Informação', mb_Ok + mb_IconExclamation);
    DBEdit2.Clear;
  end;
  end;
end;
...
procedure Tfrmcategoria.BitBtn7Click(Sender: TObject);
begin
...
procedure Tfrmcategoria.BitBtn6Click(Sender: TObject);
begin
...
procedure Tfrmcategoria.BitBtn5Click(Sender: TObject);
begin
...
procedure Tfrmcategoria.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrmcategoria.DBGrid1MouseMove(Sender: TObject;
...
procedure Tfrmcategoria.DBGrid1TitleClick(Column: TColumn);
var
  I: Integer;
begin
