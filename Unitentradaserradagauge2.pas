...
type
  Tfrmentradaserradagauge2 = class(TForm)
    Timer1: TTimer;
    Label2: TLabel;
    Gauge2: TGauge;
    Label1: TLabel;
...
var
  frmentradaserradagauge2: Tfrmentradaserradagauge2;
...
procedure Tfrmentradaserradagauge2.Timer1Timer(Sender: TObject);
...
procedure Tfrmentradaserradagauge2.FormShow(Sender: TObject);
begin
