object RepSaida3: TRepSaida3
  ...
  object QuickRep1: TQuickRep
    ...
    object QRBand5: TQRBand
      ...
      object QRExpr5: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(query5.VAL_TOT_PRODUTOS)'
        Mask = ',0.00'
        FontSize = 10
      end
      object QRExpr6: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(query5.VAL_TOT_NOTA)'
        Mask = ',0.00'
        FontSize = 10
      end
      ...
      object QRExpr7: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(TENTRADA.TOTALM3) + (query5.TOTALM3)'
        Mask = '0.0000'
        FontSize = 10
      end
      object QRExpr8: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(TENTRADA.VAL_TOT_PRODUTOS)+(query5.VAL_TOT_PRODUTOS)'
        Mask = ',0.00'
        FontSize = 10
      end
      object QRExpr9: TQRExpr
        ...
        Transparent = False
        WordWrap = True
        Expression = 'SUM(TENTRADA.VAL_TOT_NOTA)+(query5.VAL_TOT_NOTA)'
        Mask = ',0.00'
        FontSize = 10
      end
  ...
  object TENTRADA: TIBTable
    ...
    BufferChunks = 1000
    CachedUpdates = False
    MasterSource = DM.DS_SAIDAFECHAMENTO
  ...
  object DQSAIDA: TDataSource
    DataSet = query5
    Left = 64
    Top = 328
  end
  object query5: TIBTable
    Database = DM.IBDatabase1
    Transaction = DM.IBTransaction1
    ...
    Left = 110
    Top = 327
    object query5CODIGOLANCAMENTO: TIntegerField
      FieldName = 'CODIGOLANCAMENTO'
    end
    object query5CODIGOCLIENTE: TFloatField
      FieldName = 'CODIGOCLIENTE'
    end
    object query5NF: TFloatField
      FieldName = 'NF'
    end
    object query5DATA: TDateTimeField
      FieldName = 'DATA'
    end
    object query5ESSENCIA: TIBStringField
      FieldName = 'ESSENCIA'
      Size = 30
    end
    object query5QTDE_PRODUTOS: TFloatField
      FieldName = 'QTDE_PRODUTOS'
    end
    object query5TOTALM3: TFloatField
      FieldName = 'TOTALM3'
    end
    object query5VAL_TOT_PRODUTOS: TFloatField
      FieldName = 'VAL_TOT_PRODUTOS'
    end
    object query5FORMAPAGAMENTO: TIBStringField
      FieldName = 'FORMAPAGAMENTO'
      Size = 8
    end
    object query5DESCONTO: TFloatField
      FieldName = 'DESCONTO'
    end
    object query5VAL_TOT_NOTA: TFloatField
      FieldName = 'VAL_TOT_NOTA'
    end
    object query5PARCELA1: TDateTimeField
      FieldName = 'PARCELA1'
    end
    object query5PARCELA2: TDateTimeField
      FieldName = 'PARCELA2'
    end
    object query5MOEDA: TIBStringField
      FieldName = 'MOEDA'
      Size = 10
    end
    object query5NUMEROPARCELAS: TFloatField
      FieldName = 'NUMEROPARCELAS'
    end
    object query5INTERVALOPARCELAS: TFloatField
      FieldName = 'INTERVALOPARCELAS'
    end
    object query5CODIGOESSENCIA: TFloatField
      FieldName = 'CODIGOESSENCIA'
    end
    object query5TIPOPAGAMENTO: TIBStringField
      FieldName = 'TIPOPAGAMENTO'
    end
    object query5VALORENTRADA: TFloatField
      FieldName = 'VALORENTRADA'
    end
    object query5CODIGOVENDEDOR: TIntegerField
      FieldName = 'CODIGOVENDEDOR'
    end
    object query5NOMEVENDEDOR: TIBStringField
      FieldName = 'NOMEVENDEDOR'
    end
    object query5QTDEM2: TFloatField
      FieldName = 'QTDEM2'
    end
    object query5QTDEML: TFloatField
      FieldName = 'QTDEML'
    end
    object query5TIPOCODIGO: TIBStringField
      FieldName = 'TIPOCODIGO'
      Size = 2
    end
    object query5TIPOLANCAMENTO: TIBStringField
      FieldName = 'TIPOLANCAMENTO'
      Size = 30
    end
    object query5NOMECLIENTE: TIBStringField
      FieldName = 'NOMECLIENTE'
      Size = 50
    end
    object query5FECHAMENTOTIPO: TIBStringField
      FieldName = 'FECHAMENTOTIPO'
      Size = 2
    end
    object query5FECHAMENTODESCRICAO: TIBStringField
      FieldName = 'FECHAMENTODESCRICAO'
      Size = 50
    end
    object query5PRAZO: TIBStringField
      FieldName = 'PRAZO'
    end
    object query5FONECONTATO: TIBStringField
      FieldName = 'FONECONTATO'
      Size = 15
    end
    object query5FONECONTATO1: TIBStringField
      FieldName = 'FONECONTATO1'
      Size = 15
    end
    object query5ENTREGACODIGO: TIBStringField
      FieldName = 'ENTREGACODIGO'
      Size = 15
    end
    object query5ENTREGASTATUS: TIBStringField
      FieldName = 'ENTREGASTATUS'
      Size = 30
    end
    object query5ENTREGADATA: TDateTimeField
      FieldName = 'ENTREGADATA'
    end
    object query5ENTREGAPROGRAMADA: TIBStringField
      FieldName = 'ENTREGAPROGRAMADA'
      Size = 50
    end
    object query5ENTREGAPROGDATA: TDateTimeField
      FieldName = 'ENTREGAPROGDATA'
    end
    object query5ENTREGAPROGHORA: TTimeField
      FieldName = 'ENTREGAPROGHORA'
    end
    object query5OBS: TIBStringField
      FieldName = 'OBS'
      Size = 250
    end
    object query5PRAZOENTREGA: TIBStringField
      FieldName = 'PRAZOENTREGA'
      Size = 50
    end
    object query5OUTRASDESPESAS: TFloatField
      FieldName = 'OUTRASDESPESAS'
    end
    object query5VALORFRETE: TFloatField
      FieldName = 'VALORFRETE'
    end
    object query5VALORDESCONTO: TFloatField
      FieldName = 'VALORDESCONTO'
    end
    object query5DATAPEDIDO: TDateTimeField
      FieldName = 'DATAPEDIDO'
    end
    object query5FECHAMENTO_MOTIVO: TMemoField
      FieldName = 'FECHAMENTO_MOTIVO'
      BlobType = ftMemo
    end
  end
