...
type
  Tfrmentradaserradagauge1 = class(TForm)
    Timer1: TTimer;
    Label2: TLabel;
    Gauge2: TGauge;
    Label1: TLabel;
...
var
  frmentradaserradagauge1: Tfrmentradaserradagauge1;
...
procedure Tfrmentradaserradagauge1.Timer1Timer(Sender: TObject);
...
procedure Tfrmentradaserradagauge1.FormShow(Sender: TObject);
begin
