...
procedure TfrmRsaida2.BitBtn3Click(Sender: TObject);
begin
DataInicial1.Text := '';
DataFinal1.Text := '';
Close;
...
procedure TfrmRsaida2.BitBtn2Click(Sender: TObject);
begin
...
procedure TfrmRsaida2.BitBtn1Click(Sender: TObject);
begin
if DataInicial1.DateText = '00/00/0000' then
begin
Application.MessageBox('Período Inicial deve ser informado!', 'Informação', mb_Ok + mb_IconInformation);
...
procedure TfrmRsaida2.FormShow(Sender: TObject);
begin
DataInicial1.SetFocus;
end;

procedure TfrmRsaida2.DataInicial1Change(Sender: TObject);
begin
DataInicial.Text := ConverteData(DataInicial1.Text);
end;

procedure TfrmRsaida2.DataFinal1Change(Sender: TObject);
begin
DataFinal.Text := ConverteData(DataFinal1.Text);
end;

procedure TfrmRsaida2.DataInicial1Enter(Sender: TObject);
begin
Datainicial1.Text := DateToStr(now);
end;

procedure TfrmRsaida2.DataFinal1Enter(Sender: TObject);
begin
