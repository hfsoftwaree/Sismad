...
procedure TfrmMunicipio.FormDestroy(Sender: TObject);
begin
DM.TMunicipio.Close;
end;

procedure TfrmMunicipio.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TfrmMunicipio.DBGrid1TitleClick(Column: TColumn);
var
  I: Integer;
begin
  for I := 0 to DBGrid1.Columns.Count - 1 do
  DBGrid1.Columns[i].Title.Font.Style := [];
  dm.TMunicipio.IndexFieldNames := Column.FieldName;
