unit unitfrmcontasreceberestornar;
...
type
  Tfrmcontasreceberestornar = class(TForm)
    Image1: TImage;
    Panel2: TPanel;
    BitBtn1: TBitBtn;
    BitBtn3: TBitBtn;
...
var
  frmcontasreceberestornar: Tfrmcontasreceberestornar;
...
procedure Tfrmcontasreceberestornar.BitBtn3Click(Sender: TObject);
begin
Close;
end;
